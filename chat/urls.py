...
from .views import ConversationViewSet, MessageViewSet, PromptViewSet, EmbeddingDocumentViewSet, SettingViewSet, LanguageModelViewSet
...
router.register(r'language-models', LanguageModelViewSet, basename='languageModel')
